...
type SensorData struct {
	...
	Chest     string                 `protobuf:"bytes,3,opt,name=chest,proto3" json:"chest,omitempty"`
	Stom      string                 `protobuf:"bytes,4,opt,name=stom,proto3" json:"stom,omitempty"`
}
...
func (x *SensorData) GetChest() string {
	if x != nil {
		return x.Chest
	}
	return ""
...
func (x *SensorData) GetStom() string {
	if x != nil {
		return x.Stom
	}
	return ""
...
var file_spec_document_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x68, 0x65, 0x73, 0x74,
	0x12, 0x12, 0x0a, 0x04, 0x73, 0x74, 0x6f, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	...
	0x61, 0x74, 0x75, 0x73, 0x42, 0x48, 0x5a, 0x46, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x69, 0x63, 0x65, 0x73, 0x2f, 0x73, 0x70, 0x73, 0x73, 0x2f, 0x73, 0x70, 0x65, 0x63, 0x62, 0x06,
